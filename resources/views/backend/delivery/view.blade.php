                ...
                <div class="col-sm-12">
                    ...
                    <div class="float-right page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Delivery & Returns</a></li>

                        </ol>

                    </div>

                    <h5 class="page-title">Delivery & Returns</h5>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <h4> Total Delivery & Returns: {{ \App\Models\Delivery::count() }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($delivery_return as $item)
                                        <tr>
