    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="float-right page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Faqs us</a></li>

                        </ol>

                    </div>

                    <h5 class="page-title">Faqs us</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Faqs us</h4>

                @can('FAQS Create')
                    <a href="{{ route('faqs.create') }}" id="add-btn" style="color: #ffffff;"> + ADD</a>
                @endcan
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <h4> Total Faqs : {{ \App\Models\faqs::count() }}</h4>
