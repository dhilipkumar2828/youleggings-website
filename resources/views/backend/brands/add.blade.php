        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title">Create Manufacturers</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Create Manufacturers</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control" required type="text" placeholder="Enter Phone Number"
                                            id="example-text-input" name="phone_number" value="{{ old('phone_number') }}">
