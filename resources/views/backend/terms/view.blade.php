        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title">Terms & Conditions</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Terms & Conditions</h4>

                {{-- @can('Terms Create') --}}
                    <a href="{{ route('terms.create') }}" id="add-btn" style="color: #ffffff;"> + ADD</a>
                {{-- @endcan --}}
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <h4> Total Terms & Conditions: {{ \App\Models\Terms::count() }}</h4>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        {{-- @can('Terms Edit') --}}
                                                            <a class="dropdown-item"
                                                                href="{{ route('terms.edit', $item->id) }}">Edit</a>
                                                        {{-- @endcan --}}

                                                        <form action="{{ route('terms.destroy', $item->id) }}"
                                                            method="post">
