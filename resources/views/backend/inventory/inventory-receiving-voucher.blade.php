                ...
                <div class="col-12">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            @can('Inventory Receiving Voucher Create')
                                <a class="btn btn-primary btn-lg mb-3" href="{{ route('delivery-docket') }}"
                                    role="button">Delivery Docket</a>
                            @endcan
                                ...
                                <tbody>
                                    ...
                                    @foreach ($inventory as $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->supplier->vendor_name }}</td>

                                            <td>{{ $value->getbuyer->name }}</td>

                                            <td>{{ $value->purchase_order->purchase_order_id }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group m-b-10">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @can('Inventory Receiving Voucher View')
                                                            <a class="btn waves-effect waves-light"
                                                                href="{{ route('inventory.show', $value->id) }}"
                                                                data-target=".bs-example-modal-center1">View</a>
                                                        @endcan

                                                        <form action="{{ route('inventory.destroy', $value->id) }}"
                                                            ...
                                                            @can('Inventory Receiving Voucher Delete')
