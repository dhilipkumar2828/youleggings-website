    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <a href="{{ route('product.listproduct') }}" id="add-btn" style="color: #ffffff;"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <img src="{{ $Product->photo }}" alt=""
                                            style="max-height: 250px;max-width:250px" id="photo">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>Summary:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>Description:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>Brand Name:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>MPN:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>GTIN:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>GTIN Type:</b></label>

                                            <div class="col-sm-10" id="summary">
                                                <p>{{ $Product->gtin_type }}</p>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>Category:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>Manufactured:</b></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="example-text-input" class="col-sm-12 col-form-label"
                                                style="font-size: 20px"><b>Tax:</b></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <label for="example-text-input" class="col-form-label">Warehouse <span
                                                    ...
                                                    <select class="form-control form-control-sm " name="warehouse_id"
                                                        ...
                                                        @foreach (\App\Models\Warehouse::distinct()->get() as $ware)
                                                            <option value="{{ $ware->id }}"
                                                                {{ $Product->warehouse_id == $ware->id ? 'selected' : '' }}>
                                                                {{ $ware->warehouse_code . ' - ' . $ware->warehouse_name }}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <label for="example-text-input" class="col-form-label">Suppliers <span
                                                            style="color:red">*</span></label>
                                                    ...
                                                    <select class="form-control form-control-sm" name="supplier_id"
                                                        ...
                                                        @foreach (\App\Models\Suppliers::distinct()->get() as $sup)
                                                            <option value="{{ $sup->id }}"
                                    ...
                                    <!-- <div class="col-md-3">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <select class="form-control form-control-sm cat_id "

                                                         id="cat_id">

                                                        <option value="">Attribute Type</option>

                                                        @foreach (\App\Models\Attribute::distinct()->get('attribute_type') as $cate)
    ...
    @endforeach
                                    ...
                                    <!-- <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="example-text-input" class="col-md-12 col-form-label">Original Price <span style="color:red">*</span></label>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="example-text-input" class="col-md-12 col-form-label">Offer Price <span style="color:red">*</span></label>
                                           ...
                                           <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="example-text-input" class="col-md-12 col-form-label">Stock <span style="color:red">*</span></label>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            let details = ' <div class="row border1" id="child' + i + '">' +
                                ...
                                '<label for="example-text-input" class="col-sm-12 col-form-label">Attribute Type : <span style="color:red">*</span></label>' +
                        ...
                        for (let k2 = 0; k2 < ($('#chil_cat_id3').val().length); k2++) {
                            ...
                            if (variant.indexOf(vid) == -1) {
                                ...
                                let details = '<div class="card border1" id="vchild' + vid +
                                    ...
                                    '<label for="example-text-input" class="col-form-label">Image <span style="color:red">*</span></label>' +
                                    ...
                                    '<label for="example-text-input" class="col-form-label">Regular Price: <span style="color:red">*</span></label>' +
                                    ...
                                    '<label for="example-text-input" class="col-form-label">Sale Price: <span style="color:red">*</span></label>' +
                                    ...
                                    '<label for="example-text-input" class="col-form-label">Stock: <span style="color:red">*</span></label>' +
