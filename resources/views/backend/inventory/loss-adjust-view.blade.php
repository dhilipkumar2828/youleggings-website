                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div>
                                        ...
                                        <select name="purchase_order" id="purchase_order" readonly class="form-control">
    ...
    @endif -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <select name="vendor_name" id="vendor_name" readonly class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <select name="buyer" id="buyer" readonly class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <input data-parsley-type="alphanum" readonly name="deliverer" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control" readonly name="inventory_note" value="{{ $inventory->note }}" placeholder="Note"
                                ...
                                <form class="" action="#">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <select name="warehourse" readonly id="warehourse" class="form-control">
                                                ...
                                                <td>
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <input type="checkbox" class="custom-control-input "
                                                            {{ $data->product_status == 'approved' ? 'checked' : '' }}
                                                            disabled data-parsley-multiple="groups"
                                    ...
                                    <div class="form-group col-lg-6" style="display:none;">
                                        ...
                                        <div>
                                            ...
                                            <input type="hidden" class="form-control"
                                                value="{{ $inventory->total_tax }}" name="total_tax"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" readonly class="form-control" name="adjust_date"
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div>
                                            ...
                                            <textarea readonly class="form-control" name="adjust_reason" value="{{ $inventory->adjust_reason }}"
