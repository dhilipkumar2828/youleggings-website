        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title"> Tax Report</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0"> Tax Report</h4>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group m-b-10">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <!-- <a class="dropdown-item" href="customer-create.html">Edit</a> -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label for="example-text-input"
                                                                    class="col-sm-12 col-form-label">Tax Name</label>
