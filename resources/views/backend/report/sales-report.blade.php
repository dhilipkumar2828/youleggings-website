        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title"> Sales Report</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Sales Report</h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($salesreport as $item)
                                        <tr>
                                            ...
                                            <td>{{ $customer_name[$prod_row]->name }}</td>

                                            <td>{{ $qty[$prod_row]->quantity }}</td>

                                            <td>{{ $item->deliver_charge }}</td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label for="example-text-input"
                                                                    class="col-sm-4 col-form-label">Product</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label for="example-text-input"
                                                                    class="col-sm-12 col-form-label">Shipping</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label for="example-text-input"
                                                                    class="col-sm-4 col-form-label">Order Total</label>
