    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <a href="{{ route('permission.index') }}" id="add-btn" style="color: #ffffff;"><i class="fa fa-angle-left"
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('permission.store') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select name="permission_group_id" class="custom-select mt-4">

                                        <option value="">Select Role</option>

                                        @if ($permissionGroup->count() > 0)
                                            @foreach ($permissionGroup as $permissionGroups)
                                                <option value="{{ $permissionGroups->id }}">{{ $permissionGroups->name }}
                                                </option>
                                            @endforeach
                                        @endif
