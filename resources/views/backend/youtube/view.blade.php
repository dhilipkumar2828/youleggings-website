    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">youtube</h4>

                <a href="{{ route('youtube.create') }}" id="add-btn" style="color: #ffffff;"> + ADD</a>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <form action="{{ route('youtube.destroy', $item->id) }}"
                                                            method="post">
