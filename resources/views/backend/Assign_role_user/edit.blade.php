                ...
                <div class="col-12">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('Assign_role_user.update', $selectuser->id) }}" method="post">

                                @csrf

                                @method('PUT')

                                <select disabled name="user_id" class="custom-select mt-3">

                                    <option value="">Select User</option>

                                    @if ($users->count() > 0)
                                        @foreach ($users as $user)
                                            <option @if ($user->id == $selectuser->id) selected @endif
                                ...
                                <select multiple name="role_id[]" class="custom-select mt-4">

                                    <option value="">Select Role</option>

                                    @if ($roles->count() > 0)
                                        @foreach ($roles as $role)
                                            <option @if (in_array($role->id, $selectuser->roles->pluck('id')->toArray())) selected @endif
                                ...
                                <div class="d-flex">
                                    ...
                                    <!-- <button class="btn btn-secondary mt-3" type="submit">Cancle</button> -->
