    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">View Invoice</h4>

                <a href="{{ route('invoice.index') }}" id="add-btn" style="color: #ffffff;"><i class="fa fa-angle-left"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Invoice Code
                                            </label>

                                            <div class="col-sm-8">

                                                <input class="form-control" type="text" placeholder="Enter"
                                                    value="{{ $invoice->invoice_id }}" readonly id="example-text-input">

                                                <input class="form-control" type="hidden" name="invoice_id"
                                                    placeholder="Enter" value="{{ $invoice->id }}" readonly
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Invoice Date
                                            </label>

                                            <div class="col-sm-8">

                                                <input class="form-control" type="text" placeholder="Enter"
                                                    value="{{ $invoice->invoice_date }}" readonly id="example-text-input">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="text" placeholder="Enter"
                                                    ...
                                                    value="{{ $purchaseorder->delivery_date }}" id="example-text-input">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <textarea class="form-control" placeholder="Purchase Description" name="description" readonly value=""
                                                    id="example-text-input">{{ $purchaseorder->description }}</textarea>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input class="form-control" type="text" readonly=""
                                                            value="{{ $item->tax_rate }}" placeholder="Enter">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-0"><input type="checkbox"
                                                                        ...
                                                                        value="yes" checked placeholder="Enter"
                                                                        disabled readonly id="all"></div>
                                                ...
                                                <div class="row " id="attrchild0">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="example-text-input"
                                                                class="col-sm-12 col-form-label">Total Price :
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Payment
                                                Status</label>

                                            <div class="col-sm-8">

                                                <select name="invoice_payment" class="form-control"
                                                    value="{{ old('invoice_payment') }}">

                                                    <option value="">Select Payment</option>

                                                    <option value="Paid"
                                                        {{ $invoice->payment == 'Paid' ? 'selected' : '' }}>Paid</option>

                                                    <option value="UnPaid"
                                                        {{ $invoice->payment == 'UnPaid' ? 'selected' : '' }}>UnPaid
                                                    </option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Invoice Note
                                            </label>

                                            <div class="col-sm-8">

                                                <textarea class="form-control" placeholder="Invoice Note" name="invoice_note" value=""
                                                    id="example-text-input">{{ old('invoice_note') }}{{ $invoice->note }}</textarea>
