        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title">Edit Purchase Request</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Edit Purchase Request</h4>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="text" placeholder="Enter"
                                                    value="{{ $purchase->purchase_request_id }}" readonly
                                                    id="example-text-input">

                                                <input class="form-control" type="hidden" name="purchase_request_id"
                                                    placeholder="Enter" value="{{ $purchase->id }}" readonly
                                                    id="example-text-input">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input"
                                                class="col-sm-4 col-form-label">Requester</label>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <select id="requester" name="requester" value="{{ old('requester') }}"
                                                    ...
                                                    @foreach (\App\Models\User::orderBy('id', 'ASC')->get() as $key => $value)
                                                        @if ($purchase->requester == $value->id)
