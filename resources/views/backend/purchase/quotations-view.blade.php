    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">View Quotations</h4>

                <a href="{{ route('quotation.index') }}" id="add-btn" style="color: #ffffff;"><i class="fa fa-angle-left"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Estimate
                                                Number</label>

                                            <div class="col-sm-8">

                                                <input class="form-control" type="text" placeholder="Enter " readonly
                                                    value="{{ $estimate->estimate_id }}" id="example-text-input">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="text" placeholder="Enter"
                                                    value="{{ $quotation->purchase_request_id }}" readonly
                                                    id="example-text-input">

                                                <input class="form-control" type="hidden" name="purchase_request_id"
                                                    placeholder="Enter" value="{{ $quotation->id }}" readonly
                                                    id="example-text-input">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="text" placeholder="Enter " readonly
                                                    value="{{ $quotation->purchase_request_name }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="hidden" placeholder="Enter "
                                                    value="{{ $quotation->vendor_id }}" name="vendor"
                                                    id="example-text-input">

                                                <input class="form-control" readonly type="text" placeholder="Enter "
                                                    value="{{ $quotation->vendor_name }}" id="example-text-input">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" type="date" placeholder="Enter " required
                                                    value="{{ $estimate->estimate_date }}" name="estimate_date"
                                                    id="example-text-input">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Products</label>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <select class="js-example-basic-single addproduct" id="vendoritems"
                                                    ...
                                                    @foreach (\App\Models\VendorItem::where('vendoritem.vendor_id', $quotation->vendor_id)->join('products', 'products.id', '=', 'vendoritem.product_id')->get(['vendoritem.*', 'products.title']) as $key => $value)
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8"><input type="hidden"
                                                            ...
                                                            <input type="hidden" value="{{ $item->tax_rate }}"
                                                                name="tax_rate[]">
