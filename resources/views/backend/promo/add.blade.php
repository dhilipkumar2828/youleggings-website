    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Create Promo</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Promo Image
                                                left-1<br>(Image Size 750 × 413)</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Promo Left
                                                Description-1 <span style="color:red">*</span></label>

                                            <div class="col-sm-10">

                                                <textarea class="summernote" name="Session_left_description1"value="{{ old('Session_left_description1') }}"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Promo Image
                                                right-1<br>(Image Size 360 × 410)</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Promo Right
                                                Description-1 <span style="color:red">*</span></label>

                                            <div class="col-sm-8">

                                                <textarea class="summernote" name="Session_right_description1" value="{{ old('Session_right_description1') }}"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Promo Image
                                                left-2<br>(Image Size 360 × 410)</label>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group d-flex align-items-center"
                                                    ...
                                                    <input id="thumbnail2" required class="form-control" type="text"
                                                        value="" name="Session_left_2"
                                                        style="border: none !important; box-shadow: none !important; background: transparent !important; margin-left: 10px; height: 100% !important; padding: 0;"
                                                        placeholder="Select an image...">
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-6 col-form-label">Promo Left
                                                Description-2 <span style="color:red">*</span></label>

                                            <div class="col-sm-10">

                                                <textarea class="summernote" name="Session_left_description2"value="{{ old('Session_left_description2') }}"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Promo Image
                                                right-2<br>(Image Size 750 × 413)</label>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group d-flex align-items-center"
                                                    ...
                                                    <input id="thumbnail3" required class="form-control" type="text"
                                                        value="" name="Session_right_2"
                                                        style="border: none !important; box-shadow: none !important; background: transparent !important; margin-left: 10px; height: 100% !important; padding: 0;"
                                                        placeholder="Select an image...">
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <textarea class="summernote" name="Session_right_description2" value="{{ old('Session_right_description2') }}"></textarea>
