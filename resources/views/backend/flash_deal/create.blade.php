            ...
            <div class="col-sm-12">
                <div class="float-right page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Create Flash Deal</li>
                    </ol>
                </div>
                <h5 class="page-title">Create Flash Deal</h5>
            </div>
        </div>

        <div class="card m-b-30 card-body">
            <h4 class="card-title font-20 mt-0">Create Flash Deal</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('flash-deals.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="title" placeholder="e.g. FASHION MODEL">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Subtitle</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="subtitle" placeholder="e.g. THIS WINTER">
                                </div>
                            </div>
                             <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="deal_title" value="HOT DEAL">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Discount Value</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="discount_value" placeholder="e.g. 50%">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Deal End Date</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="datetime-local" name="deal_end_date">
                                </div>
                            </div>
                             <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail1" class="form-control" type="text" name="deal_image_1">
                                    </div>
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-12 text-right">
                                    <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Save Flash Deal</button>
                                </div>
                            </div>
                        </form>
                    </div>
