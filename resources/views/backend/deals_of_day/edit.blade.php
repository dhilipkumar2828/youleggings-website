        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title">Edit Deals</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Edit Deals</h4>
                                ...
                                <div class="row">
                                                ...
                                                <select class="form-control" name="product_name" id="product_name">
                                                    ...
                                                    @foreach ($products as $prod)
                                                        <option value="{{ $prod->id }}"
                                                            {{ $deals->product_name == $prod->id ? 'selected' : '' }}>
                                                            {{ $prod->title }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Sale
                                                Price</label>

                                            <div class="col-sm-8">

                                                <input class="form-control" type="number" required placeholder=""
                                                    id="example-text-input" name="sale_price"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="example-text-input" class="col-sm-4 col-form-label">Product Image
                                                <span style="color:red">*</span></label>
