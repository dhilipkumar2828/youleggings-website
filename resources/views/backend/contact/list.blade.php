    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <!-- <a href="{{ route('contact.create') }}" id="add-btn" style="color: #ffffff;"> + ADD</a> -->
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <h4> Total Enquiry List : {{ \App\Models\Contact::count() }}</h4>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group m-b-10">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <!-- <a class="dropdown-item" href="{{ route('contact.edit', $item->id) }}">Edit</a> -->
