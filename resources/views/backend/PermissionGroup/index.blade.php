        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                @can('Permission Group create')
                    <a href="{{ route('permission_group.create') }}" id="add-btn" style="color: #ffffff;"> + ADD</a>
                @endcan
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @can('Permission Group edit')
                                                            <a class="dropdown-item"
                                                                href="{{ route('permission_group.edit', $item->id) }}">Edit</a>
                                                        @endcan

                                                        <form action="{{ route('permission_group.destroy', $item->id) }}"
                                                            method="post">
