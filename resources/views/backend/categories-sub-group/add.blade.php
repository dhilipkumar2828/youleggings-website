    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="float-right page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('category-sub-group.index') }}">Group</a></li>
            ...
            <div class="card m-b-30 card-body">
                ...
                <a href="{{ route('category-sub-group.index') }}" id="add-btn" style="color: #ffffff;"><i
                ...
                <div class="col-12">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('category-sub-group.store') }}" method="post">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control" name='parent_id' style="height:auto;">
                                            ...
                                            @foreach ($parent_cate as $pcate)
                                                <option
                                                    value="{{ $pcate->id }}"{{ old('parent_id') == $pcate->id ? 'selected' : '' }}>
                                                    {{ $pcate->title }}</option>
                                            @endforeach
