    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="float-right page-breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Sub Groups</li>

                        </ol>

                    </div>

                    <h5 class="page-title">Sub Groups</h5>
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Sub Groups</h4>

                @can('Category Sub Group Create')
                    <a href="{{ route('category-sub-group.create') }}" id="add-btn" style="color: #ffffff;"> + ADD</a>
                @endcan
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group m-b-10">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @can('Category Sub Group Edit')
                                                            <a class="dropdown-item"
                                                                href="{{ route('category-sub-group.edit', $item->id) }}">Edit</a>
                                                        @endcan
    ...
    <script>
        $('input[name=toogle]').change(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('categorysubgroup.status') }}",
