    ...
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30 card-body">
                ...
                <h4 class="card-title font-20 mt-0">Edit Category</h4>
                ...
                <div class="col-12">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('category-sub-group.update', $category->id) }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control" type="text" required placeholder="Enter Category"
                                            id="example-text-input" name="title"value="{{ $category->title }}">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input class="form-control" type="text" required placeholder="Enter Category" id="example-text-input" name="slug"value="{{ old('slug') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="example-search-input" class="col-sm-2 col-form-label">Description <span
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="parent_id" class="col-sm-2 col-form-label">Parent Group</label>

                                    <div class="col-sm-10">

                                        <select class="form-control" name='parent_id' style="height:auto;">

                                            <option value="">--Parent Group--</option>

                                            @foreach ($parent_cate as $pcate)
                                                <option value="{{ $pcate->id }}"
                                                    {{ $pcate->id == $category->parent_id ? 'selected' : '' }}>
                                                    {{ $pcate->title }}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control" type="text" placeholder="Meta Title"
                                            id="example-text-input" value="{{ $category->met_title }}" name="met_title">
                            ...
                            <div class="col-sm-10">
                                ...
                                <textarea id="elm1"name="met_keyword" value="{{ $category->met_keyword }}"></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea id="elm1"name="met_description" value="{{ $category->met_description }}">{{ $category->met_description }}</textarea>
