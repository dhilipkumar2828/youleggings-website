    @if (Auth::guard('customer')->check())
        @php
            ...
            $wishlist = DB::table('wishlists')->where('customer_id', $id)->get();
        ...
        <a href="{{ url('Wishlist') }}">
            ...
            <button class="header-action-btn bg-transparent  border-0 text-white" type="button">
                ...
                <span class="icon-1 position-relative">
                    ...
                    <span class="order-list-1 d-none  text-white">{{ count($wishlist) }}</span>
        ...
        <a href="{{ url('Wishlist') }}">
            ...
            <button class="header-action-btn bg-transparent border-0 text-white" type="button">
                ...
                <span class="icon-1 position-relative">
                    ...
                    <span class="order-list-1 order-list-res d-none  text-white">0</span>
