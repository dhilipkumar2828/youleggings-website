        ...
        @foreach ($banner as $data)
            <div class="container-fluid banner">
                ...
                <div class="title-banner">
                    ...
                    <h1 style="color:black !important">Order Completed</h1>

                    <p style="color:black !important"><a href="{{ route('index') }}" title="Home"
                            style="color:black !important">Home</a><i class="fa fa-caret-right"></i>Order Completed</p>
        ...
        <div class="container container-ver2 space-padding-tb-30">
            ...
            <div class="row head-cart">
                ...
                <div class="col-md-4 space-30">
                    ...
                    <div class="item active center" style="padding: 12px 0px !important;">
                ...
                <div class="col-md-4 space-30">
                    ...
                    <div class="item center active" style="padding: 12px 0px !important;">
        ...
        <div class="container container-ver2">
            ...
            <div class="box float-left order-complete center space-50">
                ...
                <div class="icon space-20">
                    ...
                    <img src="{{ asset('frontend/img/icon-order-complete.png') }}" alt="icon">

                </div>

                <p class="box center space-50">Thank you for shopping with us, your order is complete!</p>

                <p>Your Order id:{{ $order }}<span class="small-text"></span></p>

                <div class="box">

                    <a class="link-v1 lh-50 margin-right-20 space-20 color-brand" href="{{ route('index') }}"
                        title="HOME PAGE">HOME PAGE</a>

                    <a class="link-v1 lh-50 margin-right-20 space-20 color-brand" href="{{ route('whatisnew') }}"
                        title="CONTINUS SHOPPING">CONTINUS SHOPPING</a>
