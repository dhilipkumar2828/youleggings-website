...
<body>
  ...
  <section class="hero home-page-section" id="home">
    ...
    <div class="hero-content">
      ...
      <a href="?page=shop" class="btn hero-btn">Shop The Collection</a>
    </div>
  </section>
  ...
  <section class="section home-page-section" id="shop">
    <div class="container">
      ...
      <div class="products-grid">
        <a href="?page=shop" class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Products/_DSC8742-Edit.jpg') }}" alt="Men's Collection">
          </div>
          <div class="product-details">
            <h3 class="product-name">Test 1</h3>
            <div class="product-price">View Details</div>
          </div>
        </a>
        <a href="?page=shop" class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Products/_DSC8832.jpg') }}" alt="Full Length Leggings">
          </div>
          <div class="product-details">
            <h3 class="product-name">Full Length Leggings</h3>
            <div class="product-price">Shop Range</div>
          </div>
        </a>
        <a href="?page=shop" class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Products/_DSC8128-Edit.jpg') }}" alt="Ankle Length Leggings">
          </div>
          <div class="product-details">
            <h3 class="product-name">Ankle Length Leggings</h3>
            <div class="product-price">Discover</div>
          </div>
        </a>
        <a href="?page=shop" class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Products/_DSC8533-Edit.jpg') }}" alt="Kids Leggings">
          </div>
          <div class="product-details">
            <h3 class="product-name">Kids Leggings</h3>
            <div class="product-price">For Little Ones</div>
          </div>
        </a>
      </div>
    </div>
  ...
  <section class="section about-page" id="about-page">
    <div class="about-main">
      ...
      <div class="container about-main-content">
        ...
        <h1 class="hero-title">Comfort Without <br>Compromise</h1>
      </div>
    </div>
    ...
    <div class="container page-body">
      <div class="about-hero">
        ...
        <h2 class="section-title">Built on TANTEX Legacy, Designed for Every Woman</h2>
      </div>
      ...
      <div class="about-story-split">
        <div class="about-story-card">
          <div class="about-story-content">
            ...
            <p>At You Legging, we believe every woman deserves comfort without compromise. Born from the trusted
              legacy of TANTEX, we create bottom wear that blends affordability with high-end quality.</p>
            <p>Our leggings are crafted with premium fabrics for a flattering fit, dependable stretch, and
              long-lasting durability that stays soft wash after wash.</p>
        ...
        <aside class="shop-filters">
          ...
          <div class="filter-group">
            ...
            <ul class="filter-list">
              <li><label><input type="checkbox"> YOU FULL LENGTH LEGGINGS</label></li>
              <li><label><input type="checkbox"> YOU ANKLE LENGTH LEGGINGS</label></li>
              <li><label><input type="checkbox"> YOU KIDS LEGGINGS</label></li>
              <li><label><input type="checkbox"> MERLYN FULL LENGTH LEGGINGS</label></li>
            </ul>
          </div>
        ...
        <div class="shop-products">
          <div class="products-grid">
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Nude Comfort Ankle/_DSC8045-Edit.jpg') }}" alt="Nude Comfort Ankle Legging">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Ankle Length</p>
                <h3 class="product-name">Nude Comfort Ankle</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 549</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Cobalt Core Legging/_DSC8962.jpg') }}" alt="Cobalt Core Legging">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Active Legging</p>
                <h3 class="product-name">Cobalt Core Legging</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 599</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Aqua Flex Active/_DSC9026-Edit.jpg') }}" alt="Aqua Flex Active Legging">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Gym Wear</p>
                <h3 class="product-name">Aqua Flex Active</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 649</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC7885-Edit.jpg') }}" alt="Neon Move Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Lifestyle Set</p>
                <h3 class="product-name">Neon Move Set</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 699</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC7786-Edit.jpg') }}" alt="Scarlet Sport Fit">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Performance</p>
                <h3 class="product-name">Scarlet Sport Fit</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 629</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8785-Edit.jpg') }}" alt="Floral Blush Pair">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Style Pair</p>
                <h3 class="product-name">Floral Blush Pair</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 679</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC7839-Edit.jpg') }}" alt="Olive Essential Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Essential Wear</p>
                <h3 class="product-name">Olive Essential Set</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 639</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8871-Edit.jpg') }}" alt="Mint Aura Kurti Legging">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Kurti Legging</p>
                <h3 class="product-name">Mint Aura Kurti Legging</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 569</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8659-Edit.jpg') }}" alt="Indigo Flare Bottom">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Flare Bottom</p>
                <h3 class="product-name">Indigo Flare Bottom</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 719</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC7901-Edit.jpg') }}" alt="Teal Grace Kurti Fit">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Kurti Fit</p>
                <h3 class="product-name">Teal Grace Kurti Fit</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 589</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC7937-Edit.jpg') }}" alt="Emerald Dot Kurta Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Kurta Set</p>
                <h3 class="product-name">Emerald Dot Kurta Set</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 739</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8742-Edit.jpg') }}" alt="Citrus Classic Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Classic Pair</p>
                <h3 class="product-name">Citrus Classic Set</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 689</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8065-Edit.jpg') }}" alt="Orchid Everyday Kurti">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Everyday Wear</p>
                <h3 class="product-name">Orchid Everyday Kurti</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 619</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8116-Edit.jpg') }}" alt="Plum Luxe Co-ord">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Co-ord Set</p>
                <h3 class="product-name">Plum Luxe Co-ord</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 769</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8922.jpg') }}" alt="Mustard Gleam Kurti">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Kurti Combo</p>
                <h3 class="product-name">Mustard Gleam Kurti</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 659</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8810.jpg') }}" alt="Ruby Festive Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Festive Edit</p>
                <h3 class="product-name">Ruby Festive Set</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 729</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8352-Edit.jpg') }}" alt="Crimson Asym Tunic Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Tunic Set</p>
                <h3 class="product-name">Crimson Asym Tunic</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 709</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8489-Edit.jpg') }}" alt="Ivory Print Lounge Set">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Lounge Set</p>
                <h3 class="product-name">Ivory Print Lounge</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 579</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8432-Edit.jpg') }}" alt="Sunrise Everyday Fit">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Daily Wear</p>
                <h3 class="product-name">Sunrise Everyday Fit</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 609</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8510-Edit.jpg') }}" alt="Coral Motion Pair">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Ankle Length</p>
                <h3 class="product-name">Coral Motion Pair</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 629</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8533-Edit.jpg') }}" alt="Active Blue Flex">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Active Legging</p>
                <h3 class="product-name">Active Blue Flex</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 639</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8587-Edit.jpg') }}" alt="Cherry Street Edit">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Fashion Pair</p>
                <h3 class="product-name">Cherry Street Edit</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 659</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8716-Edit.jpg') }}" alt="Azure Comfort Line">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Full Length</p>
                <h3 class="product-name">Azure Comfort Line</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 669</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
              </div>
            </div>
            ...
            <div class="product-card shop-product-card">
              <div class="product-image">
                <img src="{{ asset('frontend/images/Products/_DSC8189.jpg') }}" alt="Classic Move Essential">
              </div>
              <div class="product-details shop-product-details">
                <p class="shop-product-category">Classic Fit</p>
                <h3 class="product-name">Classic Move Essential</h3>
                <div class="shop-product-bottom">
                  <div class="product-price">INR 589</div>
                  <a href="#" class="shop-product-link">Add to Cart</a>
                </div>
      ...
      <div class="product-detail-layout">
        <div class="product-detail-gallery">
          <div class="product-detail-image-wrap">
            <img id="productDetailImage" src="{{ asset('frontend/images/Nude Comfort Ankle/_DSC8045-Edit.jpg') }}" alt="Product">
          </div>
          <div class="product-thumb-row" id="productThumbRow">
            <button class="product-thumb is-active" type="button"><img
                src="{{ asset('frontend/images/Nude Comfort Ankle/_DSC8045-Edit.jpg') }}" alt="Product thumbnail"></button>
          </div>
        </div>
  ...
  <section class="section page-view new-arrivals-page" id="new-arrivals-page">
    <div class="page-main arrivals-main" style="background-image: none; background-color: #9f9f9f;">
      ...
      <div class="container page-main-content">
        <span class="hero-subtitle">Latest Drop</span>
        <h1 class="hero-title">New Arrivals <br>Just Landed</h1>
      </div>
    </div>

    <div class="container page-body">
      <div class="text-center">
        <span class="section-subtitle">Season Edit</span>
        <h2 class="section-title">Fresh Styles This Month</h2>
      </div>
      <div class="arrivals-layout">

        <div class="products-grid arrivals-products-grid">
          <div class="product-card shop-product-card">
            <div class="product-image"><img src="{{ asset('frontend/images/Products/_DSC8742-Edit.jpg') }}" alt="Urban Motion"></div>
            <div class="product-details shop-product-details">
              <p class="shop-product-category">New Arrival</p>
              <h3 class="product-name">Urban Motion</h3>
              <div class="shop-product-bottom">
                <div class="product-price">INR 690</div>
                <a href="#" class="shop-product-link">Add to Cart</a>
              </div>
            </div>
          </div>
          ...
          <div class="product-card shop-product-card">
            <div class="product-image"><img src="{{ asset('frontend/images/Products/_DSC8832.jpg') }}" alt="Daily Sculpt"></div>
            <div class="product-details shop-product-details">
              <p class="shop-product-category">New Arrival</p>
              <h3 class="product-name">Daily Sculpt</h3>
              <div class="shop-product-bottom">
                <div class="product-price">INR 620</div>
                <a href="#" class="shop-product-link">Add to Cart</a>
              </div>
            </div>
          </div>
          ...
          <div class="product-card shop-product-card">
            <div class="product-image"><img src="{{ asset('frontend/images/Products/_DSC8533-Edit.jpg') }}" alt="Move Ease"></div>
            <div class="product-details shop-product-details">
              <p class="shop-product-category">New Arrival</p>
              <h3 class="product-name">Move Ease</h3>
              <div class="shop-product-bottom">
                <div class="product-price">INR 560</div>
                <a href="#" class="shop-product-link">Add to Cart</a>
              </div>
            </div>
          </div>
          ...
          <div class="product-card shop-product-card">
            <div class="product-image"><img src="{{ asset('frontend/images/Products/_DSC8128-Edit.jpg') }}" alt="Street Soft"></div>
            <div class="product-details shop-product-details">
              <p class="shop-product-category">New Arrival</p>
              <h3 class="product-name">Street Soft</h3>
              <div class="shop-product-bottom">
                <div class="product-price">INR 585</div>
                <a href="#" class="shop-product-link">Add to Cart</a>
              </div>
            </div>
          </div>
          ...
          <div class="product-card shop-product-card">
            <div class="product-image"><img src="{{ asset('frontend/images/Products/_DSC8910.jpg') }}" alt="Plum Drift"></div>
            <div class="product-details shop-product-details">
              <p class="shop-product-category">New Arrival</p>
              <h3 class="product-name">Plum Drift</h3>
              <div class="shop-product-bottom">
                <div class="product-price">INR 640</div>
                <a href="#" class="shop-product-link">Add to Cart</a>
              </div>
            </div>
          </div>
          ...
          <div class="product-card shop-product-card">
            <div class="product-image"><img src="{{ asset('frontend/images/Products/_DSC8752-Edit.jpg') }}" alt="Rose Daywear"></div>
            <div class="product-details shop-product-details">
              <p class="shop-product-category">New Arrival</p>
              <h3 class="product-name">Rose Daywear</h3>
              <div class="shop-product-bottom">
                <div class="product-price">INR 605</div>
                <a href="#" class="shop-product-link">Add to Cart</a>
              </div>
            </div>
          </div>
    ...
    <div class="container page-body">
      <div class="blog-top-layout">
        <article class="blog-highlight-card">
          <div class="blog-highlight-image">
            <img src="{{ asset('frontend/images/Products/_DSC8716-Edit.jpg') }}" alt="Featured Blog Post">
          </div>
      ...
      <div class="blog-articles-grid">
        <article class="blog-article-card">
          <div class="blog-article-image"><img src="{{ asset('frontend/images/Products/_DSC8716-Edit.jpg') }}" alt="Blog article"></div>
          <div class="blog-article-content">
            <p class="blog-article-date"><i data-lucide="calendar-days"></i>29-Jan-2026</p>
            <h3>How to Build a Versatile Leggings Wardrobe for Every Day</h3>
          </div>
        </article>
        <article class="blog-article-card">
          <div class="blog-article-image"><img src="{{ asset('frontend/images/Products/_DSC8785-Edit.jpg') }}" alt="Blog article"></div>
          <div class="blog-article-content">
            <p class="blog-article-date"><i data-lucide="calendar-days"></i>21-Jan-2026</p>
            <h3>Why Every Modern Closet Needs Performance Bottom Wear</h3>
          </div>
        </article>
        <article class="blog-article-card">
          <div class="blog-article-image"><img src="{{ asset('frontend/images/Cobalt Core Legging/_DSC8962.jpg') }}" alt="Blog article"></div>
          <div class="blog-article-content">
            <p class="blog-article-date"><i data-lucide="calendar-days"></i>25-Dec-2025</p>
            <h3>How Fabric Quality Improves Comfort and Long-Term Fit</h3>
          </div>
        </article>
        <article class="blog-article-card">
          <div class="blog-article-image"><img src="{{ asset('frontend/images/Products/_DSC8910.jpg') }}" alt="Blog article"></div>
          <div class="blog-article-content">
            <p class="blog-article-date"><i data-lucide="calendar-days"></i>23-Dec-2025</p>
            <h3>Choosing the Right Legging Length for Every Occasion</h3>
          </div>
        </article>
        <article class="blog-article-card">
          <div class="blog-article-image"><img src="{{ asset('frontend/images/Products/_DSC8922.jpg') }}" alt="Blog article"></div>
          <div class="blog-article-content">
            <p class="blog-article-date"><i data-lucide="calendar-days"></i>23-Dec-2025</p>
            <h3>Color Styling Guide: Matching Kurtis with Solid Leggings</h3>
          </div>
        </article>
        <article class="blog-article-card">
          <div class="blog-article-image"><img src="{{ asset('frontend/images/Products/_DSC8810.jpg') }}" alt="Blog article"></div>
          <div class="blog-article-content">
            <p class="blog-article-date"><i data-lucide="calendar-days"></i>18-Dec-2025</p>
            <h3>Care Tips to Keep Stretch Fabrics Soft and Lasting Longer</h3>
          </div>
        </article>
      </div>

      <div class="blog-show-more-wrap">
        <button class="btn blog-show-more-btn" type="button">Show More</button>
      </div>
    </div>
  </section>
  ...
  <section class="section page-view contact-page" id="contact-page">
    <div class="page-main contact-main" style="background-image: none; background-color: #9f9f9f;">
      ...
      <div class="container page-main-content">
        ...
        <h1 class="hero-title">Contact <br>You Leggings</h1>
      </div>
    </div>
    ...
    <div class="container page-body">
      <div class="contact-grid">
        ...
        <form class="contact-form">
          ...
          <input id="contact-mobile" type="tel" placeholder="+91 98765 43210">
          <label for="contact-email">Email address</label>
          <input id="contact-email" type="email" placeholder="you@example.com">
          <label for="contact-message">Message</label>
          <textarea id="contact-message" rows="5" placeholder="Write your message"></textarea>
  ...
  <section class="section page-view cart-page" id="cart-page">
    <div class="page-main cart-main" style="background-image: none; background-color: #9f9f9f;">
      <div class="hero-overlay"></div>
      <div
        style="position: absolute; inset: 0; background-image: url('{{ asset('frontend/images/bg-less/_DSC8285-Photoroom.png') }}'); background-size: auto 120%; background-position: right -20% top 50%; background-repeat: no-repeat; transform: scaleX(1); z-index: 2;">
      </div>
      <div class="container page-main-content">
        <span class="hero-subtitle">Your Bag</span>
  ...
  <!-- Products Section -->
  <section class="section home-page-section" id="new-arrivals">
    <div class="container">
      <div class="text-center">
      ...
      <div class="products-grid">
        ...
        <div class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Products/_DSC8489-Edit.jpg') }}" alt="Blue Leggings">
          </div>
          <div class="product-details">
            <h3 class="product-name">fghfghfghfgh</h3>
            <div class="product-price">₹ 945 <span class="product-old-price">₹ 950.00</span></div>
          </div>
        </div>
        ...
        <div class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Aqua Flex Active/_DSC9026-Edit.jpg') }}" alt="Legging 17">
          </div>
          <div class="product-details">
            <h3 class="product-name">Legging 17</h3>
            <div class="product-price">₹ 270 <span class="product-old-price">₹ 300.00</span></div>
          </div>
        </div>
        ...
        <div class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Aqua Flex Active/_DSC9021-Edit.jpg') }}" alt="Demo Products">
          </div>
          <div class="product-details">
            <h3 class="product-name">Demo Products</h3>
            <div class="product-price">₹ 475 <span class="product-old-price">₹ 500.00</span></div>
          </div>
        </div>
        ...
        <div class="product-card">
          <div class="product-image">
            <img src="{{ asset('frontend/images/Cobalt Core Legging/_DSC8962.jpg') }}" alt="Legging Premium 6">
          </div>
          <div class="product-details">
            <h3 class="product-name">Legging Premium 6</h3>
            <div class="product-price">₹ 440 <span class="product-old-price">₹ 450.00</span></div>
          </div>
        </div>
      </div>

      <div class="text-center" style="margin-top: 30px;">
        <a href="?page=new-arrivals" class="btn">View All Collections</a>
      </div>
    </div>
  </section>
      ...
      <div class="container">
        <div class="testimonials-carousel-wrap">
          <div class="testimonials-carousel" id="testimonialsCarousel">
            ...
            <div class="testimonial-card">
              <div class="quote-icon">“</div>
              <p class="testimonial-text">Very reasonable price, nice collections also. Jeni sister also very patience
            ...
            <div class="testimonial-card">
              <div class="quote-icon">“</div>
              <p class="testimonial-text">Absolutely amazing fit and the material is super soft. Will definitely buy
                again!</p>
  ...
  <script>
    ...
    const productCards = document.querySelectorAll('#shop-page .shop-product-card, #new-arrivals-page .shop-product-card');
    ...
    function setupShopFilters() {
      ...
      shopCards.forEach((card, index) => {
        ...
        const mappedCategory = mappedMeta.category || defaultCategory;
        ...
        card.dataset.filterCategory = mappedCategory;
    ...
    const tWrap = document.getElementById('testimonialsCarousel');
    ...
    function jumpTestimonial(index) {
      tIndex = index;
      if (tWrap) {
        tWrap.style.transition = 'transform 0.5s ease';
        // Shifting exactly by 1 card width + 1 gap per index count
        tWrap.style.transform = `translateX(calc(-${tIndex} * ((100% - var(--spacing-md) * 2) / 3 + var(--spacing-md))))`;
      }
      ...
      if (tIndex === tTotal) {
        // We scrolled to the duplicated first set, instantly reset back to original set right after the 0.5s CSS transition ends
        setTimeout(() => {
          if (tWrap) {
            tWrap.style.transition = 'none';
            tIndex = 0;
            tWrap.style.transform = `translateX(0)`;
          }
        }, 500);
      }
    }
