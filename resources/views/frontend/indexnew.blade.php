    ...
    @section('content')
        ...
        <style>
            ...
            h5.title.fontsiz.benefits.mt-0.mb-0 {
                font-size: 32px;
                padding: 32px;
            }
            ...
            section.offers-list-section.mt-5.mb-5.mobview {
                display: none;
            }

            section.browse-list-section.mobviewcategorylist {
                display: none;
            }

            section.browse-list-section.web {
                display: none;
            }
            ...
            .tabcontent {
                ...
                height: auto;
                /* This will let the content define the height */
                min-height: 100px;
                /* Optional: You can set a minimum height if needed */
                border-radius: 0 10px 10px 0;
                box-sizing: border-box;
                /* Ensure padding is included in width and height calculations */
            }

            section.browse-list-section.mobenifit {
                display: none;
            }

            hr.seperatelinee.secbreak {
                height: 0;
                display: none;
            }

            @media (max-width: 767px) {
                .row.featuredlist.mb-n4.mb-sm-n10.g-3.g-sm-6 {
                    display: grid;
                ...
                .category-item.benefits.text-center {
                    width: 30%;
                    background: #dddddd4d;
                    margin: 6px;
                }
                ...
                .category-item.benefits.text-center i {
                    font-size: 30px;
                    padding-top: 10px;
                }

                section.browse-list-section.webenifit {
                    display: none;
                }
                ...
                section.browse-list-section.webcategorylist {
                    display: none;
                }
                ...
                .container-fluid.catelistslider {
                    padding-right: 0 !important;
                }

                .category-item.text-center h5 {
                    font-size: 16px;
                    padding: 11px;
                    border-radius: 8px;
            ...
            .product-card {
                ...
                padding: 25px;
                box-shadow: 0px 0px 29px 0px #23194200;
                background: #2319420a;
            }
        ...
        <style>
            .subcategory-title1 {
                ...
                text-align: center;
                max-width: 150px;
                /* Constrain the width to match the image */
                margin: 0 auto;
                /* Center-align title below the image */
            }
        ...
        ?>
            ...
            <hr class="seperatelinee secbreak">

            <section class="hero-two-slider-area position-relative1 d-block d-md-none">
                <!-- Second section visible only on mobile view -->
                <div id="carouselExampleCaptions11" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        @foreach ($banners as $i => $b)
                            <button type="button" data-bs-target="#carouselExampleCaptions"
                                data-bs-slide-to="{{ $i }}"
                    ...
                    <div class="carousel-inner">
                        @foreach ($banners as $i => $b)
                            @if ($b->link != '0')
                                <a href="product_list/{{ $b->link }}"
                                    class="carousel-item @if ($i == 0) active @endif"
                                    style="background:url('{{ asset($b->mobile_photo) }}') no-repeat;"></a>
                            @else
                                <div class="carousel-item @if ($i == 0) active @endif"
                                    style="background:url('{{ asset($b->mobile_photo) }}') no-repeat;height: 315px !important;">
                                </div>
                            @endif
                        @endforeach
                    </div>
            ...
            @php
                $browseCategories = DB::table('categorytag')
                    ->join('categories', 'categorytag.categories_id', '=', 'categories.id')
                    ->where('categorytag.status', 'active')
                    ->where('categorytag.cate_tag', '=', 'FC')
                    ->orderBy('categorytag.id', 'desc')
                    ->limit(4)
                    ->select('categorytag.*', 'categories.title') // Select categorytag fields and categories title
                    ->get();
            @endphp
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="custom-title text-left">
                                    <h3 class="title fontsiz mt-5 mb-3">Favourite Collections<span
                                            class="headingline"></span></h3>
                                </div>
                            </div>
                        </div>

                        <div class="row featuredlist mb-n4 mb-sm-n10 g-3 g-sm-6">

                            @foreach ($browseCategories as $categoryList)
                                @if (!empty($categoryList->photo))
                                    <div class="col-md-3 col-sm-6 mb-3">
                                        <div class="category-item text-center">
                                            <a href="{{ url('product_list') . '/' . $categoryList->link }}">
                                                <img src="{{ $categoryList->photo }}" alt="{{ $categoryList->title }}"
                                                    style="object-fit: cover;border-radius: 1PX;" class="img-fluid">
            ...
            <section class="top-product-list-section webview mb-5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="custom-title text-left"
                                ...
                                <h3 class="title fontsiz mt-5 mb-3">New Arrivals <span class="headingline"></span></h3>
                                <a class="btn" href="{{ url('/newarrival_list') }}"
                                    style="margin-left: 20px; background-color: #080a54; color: #fff; border-radius: 5px; text-decoration: none;">
                                    View All
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row newarrivall">
                        <div id="owl-five" class="owl-carousel newoffersec owl-theme">
                                                    ...
                                                    @foreach ($variants_array as $vals)
                                                        <div class="size-buttons-tipAndBtnContainer">
                                                            <div class="size-buttons-buttonContainer">
                                                                <button
                                                                    class="size-buttons-size-button{{ $vals->in_stock > 0 ? '' : '-disabled' }} size-buttons-size-button-default"
            ...
            <section class="browse-list-section mobviewcategorylist">
                <!-- category list custom -->
                ...
                <div class="container-fluid catelistslider">
                    <div class="row">
                        <div class="col-12">
                            <div class="custom-title text-left">
                                <h3 class="title fontsiz mt-5 mb-3">All Categories<span class="headingline"></span></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    @foreach ($category as $c)
                        ...
                        @if ($subcategory->count() > 0)
                            <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                                <div class="custom-title text-left">
                                    <h5 class="title fontsiz" style="margin-top: 5px; margin-bottom: 2px;">
                                        {{ $c->title }}</h5>
                                </div>

                                <!-- Generate a unique ID for each category's carousel -->
                                <div id="owl-{{ $c->id }}" class="owl-carousel owl-theme">
                                    @foreach ($subcategory as $sub)
                                        <div class="item">
                                            <div class="category-item text-center">
                                                <a href="{{ url('product_list') . '/' . $sub->slug }}">
                                                    <img src="{{ $sub->photo }}" class="img-fluid" alt=""
            ...
            <script>
                $(document).ready(function() {
                    // Initialize the owlCarousel for each category using a unique ID
                    @foreach ($category as $c)
                        $("#owl-{{ $c->id }}").owlCarousel({
                            items: 1,
                            loop: true,
                            margin: 10,
                            autoplay: true,
            ...
            <section class="browse-list-section webcategorylist">
                <!-- category list custom -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="custom-title text-left">
                                <h3 class="title fontsiz mt-1 mb-3">All Categories<span class="headingline"></span></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="tab">
                            @foreach ($category as $c)
                                <button class="category-button"
                                    data-category-id="{{ $c->id }}">{{ $c->title }}</button>
                            @endforeach
                        </div>
                        ...
                        <div id="firstTab" class="tabcontent">
                            <div class="row featuredlist mb-n4 mb-sm-n10 g-3 g-sm-6">
                                ...
                                <h3 id="category_name" style="margin:0">Category:</h3>
                                <div class="subcategory-lists">
                                    <div class="category-item text-center">
            ...
            @if (!empty($advertisement->photo))
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="custom-title text-left">
                                <h3 class="title fontsiz mt-1 mb-3">Prrayasha Styles <span class="headingline"></span>
                                </h3>
                            </div>
                        </div>
                    </div>
            ...
            <!--== End Hero Area Wrapper ==-->
            <section class="browse-list-section web">
                <!-- category list custom -->
                ...
                <section class="browse-list-section">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="custom-title text-left">
                                    <h3 class="title fontsiz mt-5 mb-3">Product From Prrayasha<span
                                            class="headingline"></span></h3>
                                </div>
                            </div>
                        </div>
                                ...
                                @if (!empty($categoryList->photo))
                                    <div class="col-md-3 col-sm-6 mb-3">
                                        <div class="category-item text-center">
                                            <a href="{{ url('product_list') . '/' . $categoryList->link }}">
                                                <img src="{{ $categoryList->photo }}" alt="{{ $categoryList->title }}"
                                                    style=object-fit: cover;border-radius: 1PX;" class="img-fluid mb-3">
                                                <!--<h5 class="title fontsiz mt-0 mb-0">{{ $categoryList->link }}</h5>-->
            ...
            <section class="offers-list-section mt-5 mb-5 mobview" style="background:#2319420a">
                @php
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                                    <div class="category-item text-center">
                                        <a href="{{ url('product_list') . '/' . $offers->slug }}">
                                            <img src="{{ asset($offers->photo) }}" alt="{{ $offers->title }}"
            ...
            <div class="parallax-section parallax1">
                ...
                <section id="testimonials">
                    ...
                    <div class="testimonial-heading">
                        <p>Client Says</p>
                        <a href="{{ url('reviews') }}">
                            <h6 style="color:#364958"> Write your Reviews
                                        ...
                                        <div id="youtube">
                                            ...
                                            <a href="{{ $youtube->url }}" target="_blank" class="video-link">
                                                ...
                                                <img src="{{ asset($youtube->photo) }}" loading="lazy"
                                                    alt="{{ $youtube->photo }}"
                                                    style="margin-left: 30px; width: 270px; height: 200px; object-fit: cover;border-radius: 15PX;"
                                                    class="img-fluid mb-3">
                ...
                <div class="owl-carousel owl-theme instaowl">
                    ...
                    <div class="item">
                        ...
                        <div class="single-instagram-post">
                            ...
                            <span class="instaicons"><svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        @if (!empty($advertisement2->photo))
            <div class="container">

                <div class="row">
                    <div class="col-12">
                        <div class="custom-title text-left">
                            <h3 class="title fontsiz mt-5 mb-3">Prrayasha Styles <span class="headingline"></span></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="banner-box-footer">
                            ...
                            <img src="{{ !empty($advertisement2->photo) ? $advertisement2->photo : '' }}"
                                alt="{{ $advertisement2->photo }}">
        ...
        <section class="browse-list-section webenifit">
            <!-- category list custom -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-title text-left">
                            <h3 class="title fontsiz mt-5 mb-4">Our Benefits <span class="headingline"></span></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="row featuredlist mb-n4 mb-sm-n10 g-3 g-sm-6">
                    ...
                    <div class="col-md-4 col-sm-4 mb-3">
                        <div class="category-item benefits text-center">

                            <h5 class="title fontsiz benefits mt-0 mb-0"> <i class="fa fa-heart" aria-hidden="true"></i>
                                Budget Friendly</h5>
                    ...
                    <div class="col-md-4 col-sm-4 mb-3">
                        ...
                        <div class="category-item benefits text-center">
                            ...
                            <h5 class="title fontsiz benefits mt-0 mb-0"><i class="fa fa-truck" aria-hidden="true"></i>
                                Free Shipping</h5>
                    ...
                    <div class="col-md-4 col-sm-4 mb-3">
                        ...
                        <div class="category-item benefits text-center">
                            ...
                            <h5 class="title fontsiz benefits mt-0 mb-0"><i class="fa fa-shield" aria-hidden="true"></i>
                                100% ORIGINAL</h5>
        ...
        <section class="browse-list-section mobenifit">
            <!-- category list custom -->
            ...
            <div class="container">
                ...
                <div class="benefitrow ">
                    ...
                    <div class="category-item benefits text-center">
                        ...
                        <h5 class="title fontsiz benefits mt-0 mb-0"> Budget Friendly</h5>
                    ...
                    <div class="category-item benefits text-center">
                        ...
                        <h5 class="title fontsiz benefits mt-0 mb-0"> Free Shipping</h5>
                        </a>
                    </div>

                    <div class="category-item benefits text-center">
                        <i class="fa fa-shield" aria-hidden="true"></i>
                        <h5 class="title fontsiz benefits mt-0 mb-0">100% ORIGINAL</h5>
        ...
        <section class="browse-list-section mobenifit">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="custom-title text-left">
                            <h3 class="title fontsiz mt-5 mb-4">Connect With Us <span class="headingline"></span></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="benefitrow ">
                    ...
                    <div class="category-item benefits text-center">
                        <img src="https://taslim.oceansoftwares.in/prrayasha/public/frontend/img/insta.webp">

                    </div>

                    <div class="category-item benefits text-center">
                        <img src="https://taslim.oceansoftwares.in/prrayasha/public/frontend/img/fb.webp">

                    </div>

                    <div class="category-item benefits text-center">
                        <a href="https://www.youtube.com/@prrayashacollections">
                            <img src="https://taslim.oceansoftwares.in/prrayasha/public/frontend/img/yt.png">
                        </a>
        ...
        <script>
          ...
          $('#clear-selection').on('click', function() {
            ...
            $('#subcategory-list').append('<p>Select a category to see subcategories.</p>');
        });
        */
