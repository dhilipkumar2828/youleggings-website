...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="page-header-st3-content">
                            ...
                            <h2 class="page-header-title">Reviews</h2>
                    ...
                    <div class="col-md-6 justify-content-end d-flex">
                        ...
                        <div class="page-header-st3-content">
                            ...
                            <ol class="breadcrumb justify-content-center justify-content-md-start">
                                ...
                                <li class="breadcrumb-item active text-dark" aria-current="page">Reviews</li>
            ...
            <div class="container mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 login-form">
                                        ...
                                        <div class="product-reviews-form">
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="form-input-item">
                                                    ...
                                                    <input class="form-control input" id="phone_number" type="text"
                                                        placeholder="Mobile Number" required>

                                                    <div id="customer_err" class="text-danger"
                                                        style="font-family:auto;display:none">Please

                                                        provide Phone number</div>
                                                ...
                                                <span id="successmessage" style="display:none;">Reivew Updated Successfully
                                                    !..</span>
                                                <div class="alert alert-success" style="display:none" id="success_review">
                                                    Review
                                                ...
                                                <div class="form-input-item mb-0">
                                                    ...
                                                    <button type="button" id="review_submit1" class="btn"
                                                        onclick="reviewupdate()">Submit</button>
                        ...
                        @else
                            <h4>Please <a class="login-btn" href="{{ url('user/auth') }}">Login</a> to add review !</h4>
                            @endif
    ...
    <script>
        ...
        function reviewupdate() {
            ...
            var path = $('meta[name="base_url"]').attr('content') + '/updatereviews';
            $.ajax({
                url: path,
                type: "POST",
                data: {
                    ...
                    review_customername: $("#review_customername").val(),
