          ...
          <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
              ...
              @if (count($products) > 0)
                  @foreach ($products as $key => $product)
                      ...
                      <div class="col-6 col-lg-4 col-md-6 mb-1 mb-sm-9">
                          ...
                          <div class="product-item single-productsBox">
                              ...
                              <div class="product-thumb product-image">
                                  ...
                                  <a class="d-block" href="{{ url('products') . '/' . $product->slug }}">
                                      ...
                                      <img src="{{ url($aProductvariant_photo[$product->id]) }}" loading="lazy"
                                          alt="Image-HasTech" class="home_product_img product-first-image">

                                      <img src="{{ url($ahover_image_photo[$product->id]) }}" loading="lazy"
                                  ...
                                  <div class="product-action">
                                      ...
                                      <button type="button" data-product_id="{{ $product->id }}"
                                          ...
                                          @php
                                              $currentUser =
                                                  auth()->guard('users')->user() ?? auth()->guard('guest')->user();
                                          @endphp
                              ...
                              <div class="product-info text-center">
                                  ...
                                  @if (count($newsizevariant) == 0)
                                      <div class="outofstock single"
                                          style="padding: 0px 39px;border: 1px solid #222e64;background: #222e64;color: #fff;width:100%;">
                                          <p>Out Of Stock</p>
                                      </div>
                                  @endif
...
-->
                                          ...
                                          <!--        class="price-old"> ₹{{ number_format($newsizevariant1->regular_price, 2, '.', '') }}</span>-->
                                          <!--
@endif-->
                                          <!--    <span class="price"><span>₹</span>{{ number_format($price, 2, '.', '') }}</span></div>-->
                                          <!-----
                                             @if ($product->stock > 0)
