                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card mini-stat m-b-30">
                        ...
                        <div class="p-3 bg-primary text-white">
                            ...
                            <h6 class="text-uppercase mb-0">Total Banner</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-muted">
                                ...
                                <h5 class="m-0">{{ \App\Models\Banner::count() }}<i
                                        class="mdi mdi-arrow-up text-success ml-2"></i></h5>
                    ...
                    <div class="card mini-stat m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            <div class="border-bottom pb-4">
                                ...
                                <span class="badge badge-success"> -02% </span> <span class="ml-2 text-muted">From previous
                                    period</span>
                            ...
                            <div class="mt-4 text-muted">
                                ...
                                <h5 class="m-0">1542<i class="mdi mdi-arrow-up text-success ml-2"></i></h5>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card mini-stat m-b-30">
                        ...
                        <div class="p-3 bg-primary text-white">
                            ...
                            <h6 class="text-uppercase mb-0">Total Customers</h6>Category
                    ...
                    <div class="card mini-stat m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 text-muted">
                                ...
                                <h5 class="m-0">{{ \App\Models\Category::count() }}<i
                                        class="mdi mdi-arrow-up text-success ml-2"></i></h5>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card mini-stat m-b-30">
                        ...
                        <div class="p-3 bg-primary text-white">
                            ...
                            <h6 class="text-uppercase mb-0">Total Brands</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="border-bottom pb-4">
                                ...
                                <span class="badge badge-success"> -02% </span> <span class="ml-2 text-muted">From
                                    previous period</span>
                            ...
                            <div class="mt-4 text-muted">
                                ...
                                <h5 class="m-0">{{ \App\Models\Brand::count() }}<i
                                        class="mdi mdi-arrow-up text-success ml-2"></i></h5>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card mini-stat m-b-30">
                        ...
                        <div class="p-3 bg-primary text-white">
                            ...
                            <h6 class="text-uppercase mb-0">Total Transactions</h6>
