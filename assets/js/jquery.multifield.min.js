...
/* jquery-multifield - v2.0.0 - https://github.com/maxkostinevich/jquery-multifield */ ! function(a, b, c, d) {
    var e = function(b, c) {
        this.elem = b, this.$elem = a(b), this.options = c, this.localize_i18n = {
            multiField: {
                messages: {
    ...
    e.prototype = {
        ...
        init: function() {
            var b = this;
            return this.config = a.extend({}, this.defaults, this.options, this.metadata), "default" !== this.config.locale && (b.localize_i18n = this.config.locale), this.getSectionsCount() < 2 && a(this.config.btnRemove, this.$elem).hide(), this.$elem.on("click", this.config.btnAdd, function(a) {
        ...
        cloneSection: function() {
            if (0 !== this.config.max && this.getSectionsCount() + 1 > this.config.max) return !1;
        ...
        removeSection: function(b) {
            if (confirm(this.localize_i18n.multiField.messages.removeConfirmation)) {
                ...
                c <= 2 && a(this.config.btnRemove, this.$elem).hide(), b.slideUp("fast", function() {
                    a(this).detach()
                })
            }
        },
