...

{
   ...
   function __construct()
...

    {
        ...
        $categories=Category::whereIn('created_by',$user)->where('is_parent',0)->orderBy('id','DESC')->get();

        return view('backend.categories-sub-group.view',compact('categories'));
...

    {
        ...
        return view('backend.categories-sub-group.add',compact('parent_cate'));
...

    {
        ...
        if($status){
            ...
            return redirect()->route('category-sub-group.index');
...

    {
        ...
        if($category){
            ...
            return view('backend.categories-sub-group.edit',compact(['category','parent_cate']));
